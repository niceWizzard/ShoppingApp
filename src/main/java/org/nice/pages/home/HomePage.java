...
public class HomePage extends Routeable {
    final ProductItemModel[] products = new ProductItemModel[]{
            new ProductItemModel("Nig** shoe", 420, "black_shoes.jpg", "lkjalksdjDSAFLK"),
            new ProductItemModel("Blue Shoe", 420, "blue_shoes.jpg", "LSDKJFLKSDEN"),
            new ProductItemModel("Crocs Shoe", 420, "crocs.jpg", "LKSJDILFE"),
            new ProductItemModel("Red Shoe", 420, "red_shoe.jpg", "LKSDOKW1289jk"),
            new ProductItemModel("Vomero 17 Pro Max", 420, "vomero.png", "LSKDJILFLKJE"),
    };
    public HomePage() {
